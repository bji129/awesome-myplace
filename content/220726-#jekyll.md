...
Category: news
Tags: markdown, learn, jekyll
Authors: Brandon Ji
Summary: Jekyll is a static site generator that takes Markdown files and converts them to a website. Jekyll is a free and open-source application written in the Ruby programming language. 
